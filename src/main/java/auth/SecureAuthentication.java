...
//        try {
//            System.out.println("Name = " + request.getParameter("email_id"));
//            if (token == null && request.getParameter("email_id") != null) {
...
////                
//                Credential credential = new UsernamePasswordCredential(email_id, new Password(password));
...
//                        System.err.println("i am in admin role");
//                        request.getRequestDispatcher("adminTemplate/dashboard.jsf").forward(request, response);
//                    }
//                    if (result.getCallerGroups().contains("user")) {
//                        System.err.println("i am in user role");
//                        request.getRequestDispatcher("userTemplate/home.jsf").forward(request, response);
//                    }
//              
//                    return status;
//
//                } else {
//                    KeepRecord.setErrorStatus("Either email_id or Password is wrong !");
//                    response.sendRedirect("Login.jsf");
//
